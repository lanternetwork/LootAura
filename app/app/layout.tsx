...
try {
  ...
  if (process.env.NEXT_PUBLIC_DEBUG === 'true') {
    console.warn('[APP_LAYOUT] Invalid siteUrl for metadataBase:', siteUrl)
  }
}
...
// Native app shell layout - excludes web footer
// This layout is used for the /app namespace routes
      ...
      <body className="min-h-screen bg-neutral-50 text-neutral-900">
        ...
        <Providers>
          <ErrorBoundary>
            ...
            {/* Footer intentionally excluded for native app shell */}
            <PWAComponents />
            <DebugToggle />
            <ToastContainer
