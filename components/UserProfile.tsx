      ...
      {open && (
        <div role="menu" className="absolute right-0 top-full mt-2 w-48 bg-white rounded-lg shadow-lg border z-50">
          <div className="p-2 flex flex-col">
            <a href="/account" onClick={(e) => { if (handleNativeNavigation('/account', e)) { setOpen(false); return } setOpen(false) }} className="px-2 py-2 text-sm text-neutral-700 hover:bg-neutral-100 rounded">Account settings</a>
