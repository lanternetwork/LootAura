...
interface SocialLinksEditorCardProps {
...
export function SocialLinksEditorCard({ initialLinks, onSaved }: SocialLinksEditorCardProps) {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      console.error('[SOCIAL_LINKS_EDITOR] Save error:', error)
