...
| 8 | Manual drop script + runbook | After Phase 6 verify |
...
4. [ ] When gates pass: run [drop script](../../scripts/audit/profile-drop-legacy-public-profiles.sql), then add migration `217` to repo  
