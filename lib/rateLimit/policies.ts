...
export const Policies = {
  ...
  FAVORITES_MINUTE:  { name: 'FAVORITES_MINUTE',  limit: 15, windowSec: 60, scope: 'user' as const },
  DRAFT_AUTOSAVE_MINUTE: { name: 'DRAFT_AUTOSAVE_MINUTE', limit: 20, windowSec: 60, scope: 'user' as const },
