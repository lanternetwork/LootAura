-- GATED_FALSE_POSITIVE_RECONCILIATION_V1: schedule_wait false-exclusion primary bucket.
...
COMMENT ON CONSTRAINT ystm_coverage_observations_false_exclusion_bucket_chk
  ON lootaura_v2.ystm_coverage_observations IS
  'False-exclusion primary bucket enum (includes schedule_wait for address-gated unlock waits).';
