...
describe('buildIngestionDiagnostics', () => {
  ...
  it('includes dashboard supplements when provided', () => {
    const data = {
      ok: true,
      generatedAt: '2026-05-22T00:00:00Z',
      detailFirstMetricsBaselineAt: null,
      detailFirstProof: evaluateDetailFirstProofProtocol({
        metricsBaselineAt: null,
        detailFirst: {
          attempted: 0,
          succeeded: 0,
          published: 0,
      ...
      volume: {
        ...
        fetch: { insertYield24h: 0, saturationRate24h: 0, configsOverdue: 0 },
        addressLifecycle: { byStatus: {}, enrichmentBacklog: 0 },
        imageEnrichment: { backlog: 0 },
      ...
      supplements: {
        ...
        seoOperational: {
          snapshot: {
            ...
            rollout: {
              indexingAllowed: false,
              blockers: ['ops allowlist blocked'],
              qualifiedMetroSlugs: [],
            },
            metroQualification: [],
            metroParticipation: { participatingMetroSlugs: [] },
            sitemap: {
              staticUrlCount: 1,
              listingChunkCount: 1,
              listingUrlCount: 10,
            ...
            metrics: {
              ...
              duplicateVisibleClusters: 0,
              catalogRepairQueue: 100,
              missingValidUrls: 50,
            },
          },
          rolloutState: {
